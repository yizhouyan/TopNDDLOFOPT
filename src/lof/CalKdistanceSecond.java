...
//			});
			...
			for (int i = 0; i < sortedData.size(); i++) {
				...
				if (o_S.getType() == 'C') {
					o_S = findKNNForSingleObjectBaseline(o_S, i, sortedData);
					// output data point
		 ...
		 */
		private MetricObject findKNNForSingleObjectBaseline(MetricObject o_R, int currentIndex,
